package io.github.tonyshkurenko.slidinguppanelsetup.behaviors;
...
import io.github.tonyshkurenko.slidinguppanelsetup.R;
...
public class BottomSheetBehaviorGoogleMapsLike<V extends View>
  ...
  /** @hide */
  @IntDef({
      STATE_EXPANDED, STATE_COLLAPSED, STATE_DRAGGING, STATE_ANCHOR_POINT, STATE_SETTLING,
      STATE_HIDDEN
  ...
  public void addBottomSheetCallback(BottomSheetCallback callback) {
    if (mCallback == null) mCallback = new ArrayList<>();
  ...
  /**
   * A utility function to get the {@link BottomSheetBehaviorGoogleMapsLike} associated with the
   * {@code view}.
   *

...
public class SecondAppBarLayoutBehavior extends AppBarLayout.ScrollingViewBehavior {
  ...
  private void initValues(final View child, View dependency) {
    ...
    for (int i = 0; i < mToolbar.getChildCount(); i++) {
      ...
      if (toolBarChild instanceof TextView &&
          ...
          ((TextView) toolBarChild).getText()
              .toString()
              .contentEquals(
                  mContext.getResources().getString(R.string.key_binding_default_toolbar_name))) {
    ...
    if (textViewFromToolbar == null) return;
  ...
  private void showTitleInToolBar() {
    ...
    mTitleView.getLocationOnScreen(initialLocation);
    ...
    viewPropertyAnimator = textViewFromToolbar.animate()

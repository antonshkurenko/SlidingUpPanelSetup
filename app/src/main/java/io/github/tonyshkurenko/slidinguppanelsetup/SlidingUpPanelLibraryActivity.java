...
public class SlidingUpPanelLibraryActivity extends AppCompatActivity {
  ...
  private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
    @Override public void onClick(View v) {
      ...
      Toast.makeText(SlidingUpPanelLibraryActivity.this, "Clicked: " + v.getClass().getSimpleName(),
  ...
  private final AdapterView.OnItemClickListener mOnItemClickListener =
      new AdapterView.OnItemClickListener() {
        @Override public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
          Toast.makeText(SlidingUpPanelLibraryActivity.this,
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_sliding_up_panel_library);
    ...
    mPanelLayout.setFadeOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        Toast.makeText(SlidingUpPanelLibraryActivity.this, "Fade click!", Toast.LENGTH_SHORT)
            .show();
